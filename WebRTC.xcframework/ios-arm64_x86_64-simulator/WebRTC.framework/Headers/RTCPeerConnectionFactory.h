...
@class RTC_OBJC_TYPE(RTCCustomAudioProcessing);
...
@protocol RTC_OBJC_TYPE(RTCCustomAudioDeviceDelegate);
...
- (instancetype)initWithEncoderFactory:(nullable id<RTCVideoEncoderFactory>)encoderFactory
                    ...
                    audioDeviceInterface:(nullable id<RTCCustomAudioDeviceDelegate>)audioDeviceInterface
                       audioProcessing:(nullable RTCCustomAudioProcessing*)audioProcessing;
